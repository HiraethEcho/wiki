...
> [!important] 迁移这个网站内容迁移到新网站。包括
>
> - [memex](https://memex.keinmal.top)
>   其中[forest](https://memex.keinmal.top/forest)包括这里的clip,savoir,read/excerpt,living等
...
- [Dev](/wiki/dev/index): My notes about code, computer and software. I use Arch
  by the way.
- [Living](/wiki/living/index): Life Hacker!
- [Read](/wiki/read/index): My Reading notes. 包括直接摘抄和总结反思。
- ~~[Math](/wiki/math/index): My notes about math. Mostly about Algebraic
  Geometry. Includes [notes and annotations](/wiki/math/zotero) form `zotero`~~
