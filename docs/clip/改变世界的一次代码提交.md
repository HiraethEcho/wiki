...
- description: TL;DR 本文较长，如果对 Git 内部实现不感兴趣可以快速跳过中间两个章节。
- source: [url](https://hutusi.com/articles/the-greatest-git-commit)
- author: 胡涂说
...
![Linus Torvalds](https://cdn.hutusi.com/images/people/linus-torvalds.jpg)
...
学习 Git 的内部实现，最好的办法是看 Linus 最初的代码提交，checkout 出 git 项目的第一次提交节点（方法参见博客： [《阅读开源代码小技巧》](https://hutusi.com/articles/git-paging) ），可以看到代码库中只有几个文件：一个 README，一个构建脚本Makefile，剩下几个 C 源文件。这次 commit 的备注写的也非常特别： Initial revision of “git”, the information manager from hell.
...
![Git simple objects model](https://cdn.hutusi.com/images/software/git-object-model-tree.png?w=1280)
...
![Git Working tree, staging area, and Git directory.](https://cdn.hutusi.com/images/software/git-working-tree-staging-area-git-repo.png?w=1280)
...
[« 如何成为一名黑客](https://hutusi.com/articles/how-to-become-a-hacker) [只买书：一个失败的微信小程序产品 »](https://hutusi.com/articles/failure-of-zhimaishu)

本文采用 [「CC BY-SA 4.0」](http://creativecommons.org/licenses/by-sa/4.0/deed.zh) 知识共享许可协议，如果还喜欢其他文章， 欢迎 [订阅“胡涂说”博客](https://hutusi.com/subscription) 。![公众号](https://cdn.hutusi.com/images/site/qrcode_for_hututalk_8cm.jpg)

微信公众号同步更新，欢迎关注😊

## Explore →

[所有文章](https://hutusi.com/articles/) [所有周刊](https://hutusi.com/weeklies/)
